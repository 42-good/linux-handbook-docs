...
## 详细信息
 ...
 - 图形安装界面：是
 - 换源教程：
    - TUNA: 无，镜像地址: https://mirrors.tuna.tsinghua.edu.cn/artixlinux/
    - USTC: 无
    - MirrorZ: 无，镜像地址: https://mirrors.cernet.edu.cn/artixlinux/

## 风味

### 初始化系统分类 (Init Editions)

 - OpenRC: 使用 Gentoo Linux 开发的 OpenRC 作为初始化系统，在 Artix 中最为稳健和流行。
